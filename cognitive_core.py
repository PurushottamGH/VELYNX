...
try:  # pragma: no cover - exercised by environment, not by unit tests
    from cognitive_health import HealthReport, Regime
    from cognitive_health import LAMBDA, MU, NU
...
try:  # The C7 sensorium trio. Imported defensively so the C1-C6 library above
    ...
    from environment import Environment, SensorArray
    from latent_cause_engine import LatentCause, LatentCauseEngine
...
# Free-Energy coupling coefficients imported from cognitive_health (→ validation.metrics)
