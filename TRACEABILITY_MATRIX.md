...
| **Implementation module** | `program_a/retrieval/*`, `experiments/EXP-1/{dataset,run,analysis,control_bm25,goodhart_guard,decision}.py`, `core/measurement/metrics.py` (ECE) | §9-DeepSeek, repository_v2 Program A |
